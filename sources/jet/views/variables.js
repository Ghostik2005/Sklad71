...
export const new_doc_context_center_dt_optoins = [ //меню создания новых документов //наверное тоже будем загружать с сервера
    {id: 901, value: "Приходный документ"},
    {id: 902, value: "Отгрузка"},
]

export const arrivals_menu_options_excludes = [ //исключения для меню поступлений
    903, 904, 905, 906, 1002, 100, 101, 102, 200, 201, 202, 203, 1004, 10
]

export const balance_menu_options_excludes = [ //инсключения для меню остатков
    903, 904, 905, 906, 1001, 3, 4, 5, 6, 7, 1002, 100, 101, 102, 200, 201, 202, 203, 1004, 10
]

export const orders_menu_options_excludes = [ //исключения для меню заказов
    903, 904, 905, 906, 2, 1001, 3, 4, 5, 6, 7, 100, 101, 102, 202, 203
]

export const shipments_menu_options_excludes = [ // исключения для меню отгрузок
    903, 904, 905, 906, 2, 1002, 100, 101, 102, 200, 201, 202, 203, 1004, 10
]


export const new_docs_menu = [ // кнопки создания новых документов
...
export const refs_menu = [ // кнопки меню справочников
