...
export default class OrdersMenuFilters extends JetView{
    config(){
                                ...
                                on: {
                                    onItemClick: ()=>{
                                        ...
                                        if (this.isVisible()) {
                                            ...
                                            // console.log('b', b);
                                            if (b) {
                                                this.app.commonWidgets.orders.quick_filters.checkTag("__" + b, b, false) ;
                                            } else {
                                                this.app.commonWidgets.orders.quick_filters.uncheckAll()
                                            };
                                        };
                                        this.app.commonWidgets.orders.center_table.getData();
                                        this.saveValues();
                                        this.hide();
                                    }
                                }
    ...
    saveValues() {
        ...
        this.app.commonWidgets.orders.status_bar.setStatus(this.values);
    }
    ...
    ready() {
        ...
        this.app.commonWidgets.orders['menu_filters'] = this;
        setTimeout( ()=> {
        let columns = this.app.commonWidgets.orders.center_table.getHeaders()
        columns.forEach((col)=>{
