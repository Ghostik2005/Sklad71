...
import {movementsProdSelColumns} from "../variables/movement_product_selection_dt";
import {balance_processing} from "../models/data_processing";
import ProductCardView from "../models/product_card";



export default class MobementSelectionView extends JetView{
            ...
            body: {
                rows:[
                    ...
                    {view: "datatable",
                        ...
                        scroll: 'xy',
                        tooltip: true,
                        columns: movementsProdSelColumns,
                        // leftSplit: 1,
